...
class jogo_da_velha:
    ...
    def __init__(self):
        ...
        self.janela.geometry("1300x1600+2500+210")
      ...
      # Frame da Minha Assinatura
        ...
        self.Assinatura_Rodape = Label(self.minhaAssinatura, text="Criado por: Mauri Sebastiao da Luz", font="Arial 13",  bg="black", fg="white", width=800)
      ...
      # Jogador 1 do rodape        
        ...
        self.label_dinamica1 = StringVar()
        self.Jogador_1 = Label(self.Frame_do_Botão_Add_Nomes_dos_Jogadores, textvariable=self.pegar1)
        self.Jogador_1.pack(padx=10, side=LEFT)
      
      # Botao Add Nomes dos Jogadores        
        self.Adicione_os_Jogadores = Button(self.Frame_do_Botão_Add_Nomes_dos_Jogadores, text="Cadastro de Jogadores", font="Arial 12 bold", fg="white", highlightbackground="pink",  bg="black", width=19,command=lambda:self.tela_Cadastro_de_jogadores())
      ...
      # Jogador 2 do rodape        
        ...
        self.Jogador_2 = Label(self.Frame_do_Botão_Add_Nomes_dos_Jogadores, textvariable=self.pegar2)
...
# **************Entrada dos nomes******************************
    def exibe0(self):
        ...
        nome = self.entrada_nome_do_jogador1.get()
        self.label_dinamica1.set(nome)
        
        nome = self.entrada_nome_do_jogador2.get()
        self.label_dinamica.set(nome)

    
    def pegar1(self):
        nome1 = self.label_dinamica1.get()
    
    def pegar2(self):
        nome2 = self.label_dinamica2.get()
    '''
    def exibe1(self,):
        nome = self.entrada_nome_do_jogador1.get()
        self.label_dinamica1.set(nome)
...
# ***************Tela de cadastro dos jogadores****************
    def tela_Cadastro_de_jogadores(self):
      ...
      # Criação da janela tela  cadastro de jogadores             
        ...
        self.cadastro.title("Cadastro de Jogadores")
      ...
      # Entry --> entrada de nome do jogador      
        self.entrada_nome_do_jogador1 = Entry(self.Frame_entrada_de_nomes, textvariable=self.pegar1, font="Arial 14 bold", width=11)
        self.entrada_nome_do_jogador1.pack(side=LEFT, padx=40, pady=1)
        self.entrada_nome_do_jogador2 = Entry(self.Frame_entrada_de_nomes, textvariable=self.pegar2, font="Arial 14 bold", width=11)
      ...
      # Botão Cadastrar cadastro de jogadores
        self.btnCadastrar = Button(self.Frame_Botao_iniciar_Jogo, text="Cadastrar e Jogar", font="Arial 12 bold", fg="white", highlightbackground="pink",  bg="black", width=30,command=self.exibe0)
